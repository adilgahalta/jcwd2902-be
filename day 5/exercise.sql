...
create table branches (id int AUTO_INCREMENT PRIMARY KEY, branch_name VARCHAR(255), pic VARCHAR(255), address VARCHAR(255), city VARCHAR(255), province VARCHAR(255));
